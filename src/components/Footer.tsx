...
const Footer = () => {
  return (
    <footer className="flex flex-col text-white bg-primary-100">
      <div className="flex max-md:flex-col flex-wrap justify-between gap-20 sm:px-16 px-6 py-10 max-w-[1440px]">
